...
"""
    ...
    AulasZeus descrição do seu projeto.
...
from aulaszeus import extensions
from aulaszeus.users.models import User, Role
from aulaszeus.users.forms import CustomLoginForm, ExtendedRegisterForm
from aulaszeus import users, admin, public
...
def create_app():
    ...
    # Config App
    app.config.from_object("aulaszeus.config.app_config")
...
def register_blueprints(app):
    ...
    """
    app.register_blueprint(users.controllers.blueprint)
    app.register_blueprint(admin.controllers.blueprint)
