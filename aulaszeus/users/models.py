# -*- coding: utf-8 -*-
"""
    aulaszeus.users.models
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    aulaszeus user models module
...
from aulaszeus.extensions import db
...
class User(db.DynamicDocument, UserMixin):
    ...
    imagem = db.ImageField(size=(800, 800, True),
        thumbnail_size=(84, 84, True))
    endereco = db.EmbeddedDocumentField(Address, default=Address)
